...
if( !defined( 'FLUID_VIDEO_EMBEDS_VERSION' ) ) define( 'FLUID_VIDEO_EMBEDS_VERSION', '1.0.0' );

// The cache prefix
if( !defined( 'FLUID_VIDEO_EMBEDS_CACHE_PREFIX' ) ) define( 'FLUID_VIDEO_EMBEDS_CACHE_PREFIX', 'rsc' );
